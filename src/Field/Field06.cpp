...
Field06::Field06(IGameEventHandler* gameEvent) : Field("./assets/map/map5.csv") {
	...
	_layer.at(LayerType::GREEN)->addStagePuzzle(
		new MovingBoxArea(gameEvent, [=]() {
			_layer.at(LayerType::GREEN)->addGameObj(new BlueCrystal(
	...
	_layer.at(LayerType::GREEN)->addGameObj(new Epigraph(gameEvent,
